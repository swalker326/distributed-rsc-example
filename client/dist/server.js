require("./client/server.23c2b542.js");
require("./client/server.c30d4f14.js");
require("./server/RSC.cc9bb800.js");
require("./client/RSC.4eb4de98.js");
require("./client/RSC.df3bac73.js");
...
})({"1CVDg":[function(require,module,exports,__globalThis) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SERVER_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "584c96e5a1c62044";
var HMR_USE_SSE = false;
module.bundle.HMR_BUNDLE_ID = "d4cfdfa5e44f5934";
"use strict";
...
},{}],"aRXdd":[function(require,module,exports,__globalThis) {
if (typeof AsyncLocalStorage === "undefined") try {
    globalThis.AsyncLocalStorage = require("6d22663fb0577e2f").AsyncLocalStorage;
} catch  {}

},{"6d22663fb0577e2f":"node:async_hooks"}],"aROs2":[function(require,module,exports,__globalThis) {
// Server dependencies.
...
app.get('/', async (req, res)=>{
    ...
    let stream = (0, _node.renderRSC)(/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _rsc.RSC), {}, void 0, false, {
        fileName: "client/server/server.tsx",
        lineNumber: 20,
        columnNumber: 26
    }, undefined));
...
},{"react/jsx-dev-runtime":"j7ngv","express":"express","@parcel/rsc/node":"kddae","./RSC":"13QQd","@parcel/transformer-js/src/esmodule-helpers.js":"9CkkJ"}],"j7ngv":[function(require,module,exports,__globalThis) {
'use strict';
module.exports = require("4e21d88679390b0f");

},{"4e21d88679390b0f":"dDhZ1"}],"dDhZ1":[function(require,module,exports,__globalThis) {
/**
 * @license React
...
(function() {
    ...
    var React = require("5e3b05e0e8d511aa"), REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler");
...
},{"5e3b05e0e8d511aa":"7Ph5U"}],"7Ph5U":[function(require,module,exports,__globalThis) {
'use strict';
module.exports = require("566c2b16a86f1ac5");

},{"566c2b16a86f1ac5":"60F0V"}],"60F0V":[function(require,module,exports,__globalThis) {
/**
 * @license React
...
},{}],"kddae":[function(require,module,exports,__globalThis) {
/* @jsxRuntime automatic */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderRSC", ()=>renderRSC);
parcelHelpers.export(exports, "renderHTML", ()=>renderHTML);
parcelHelpers.export(exports, "renderRequest", ()=>renderRequest);
parcelHelpers.export(exports, "callAction", ()=>callAction);
var _stream = require("stream");
var _serverEdge = require("react-server-dom-parcel/server.edge");
var _server = require("./server");
function renderRSC(root, options) {
    return (0, _stream.Readable).fromWeb((0, _serverEdge.renderToReadableStream)(root, options));
}
async function renderHTML(root, options) {
    let htmlStream = await (0, _server.renderHTML)(root, options);
    return (0, _stream.Readable).fromWeb(htmlStream);
}
const temporaryReferencesSymbol = Symbol.for('temporaryReferences');
async function renderRequest(request, response, root, options) {
    options = {
        ...options,
        temporaryReferences: options?.temporaryReferences ?? request[temporaryReferencesSymbol]
    };
    if (request.headers.accept?.includes('text/html')) try {
        ...
        let renderedError;
        try {
            renderedError = options?.renderError ? await (0, _server.renderHTML)(options.renderError(error), options) : await (0, _server.renderDevError)(error, options);
        } catch  {
            renderedError = '<h1>Something went wrong!</h1>';
        }
        if (typeof renderedError === 'string') response.end(renderedError);
        else (0, _stream.Readable).fromWeb(renderedError).pipe(response);
    }
    else {
...
async function callAction(request, id) {
    request[temporaryReferencesSymbol] ??= (0, _serverEdge.createTemporaryReferenceSet)();
    let req = new Request('http://localhost' + request.url, {
        method: 'POST',
        headers: request.headers,
        body: (0, _stream.Readable).toWeb(request),
        // @ts-ignore
        duplex: 'half'
    });
    req[temporaryReferencesSymbol] = request[temporaryReferencesSymbol];
    return (0, _server.callAction)(req, id);
}

},{"stream":"stream","react-server-dom-parcel/server.edge":"gxgmV","./server":"2tNXh","@parcel/transformer-js/src/esmodule-helpers.js":"9CkkJ"}],"gxgmV":[function(require,module,exports,__globalThis) {
'use strict';
var s;
s = require("742c98a54a3eaa93");
...
},{"742c98a54a3eaa93":"eShnK"}],"eShnK":[function(require,module,exports,__globalThis) {
/**
 * @license React
...
(function() {
    ...
    function serializeReadableStream(request, task, stream) {
        function progress(entry) {
            if (!aborted) {
                if (entry.done) request.abortListeners.delete(abortStream), entry = streamTask.id.toString(16) + ":C\n", request.completedRegularChunks.push(stringToChunk(entry)), enqueueFlush(request), aborted = !0;
                else try {
    ...
    function serializeClientReference(request, parent, parentPropertyName, clientReference) {
        var clientReferenceKey = clientReference.$$id + "#" + clientReference.$$name, writtenClientReferences = request.writtenClientReferences, existingId = writtenClientReferences.get(clientReferenceKey);
        ...
        try {
            var clientReferenceMetadata = clientReference.$$importMap ? [
                clientReference.$$id,
    ...
    function serializeBlob(request, blob) {
        function progress(entry) {
            if (!aborted) {
                if (entry.done) request.abortListeners.delete(abortBlob), aborted = !0, pingTask(request, newTask);
    ...
    function reviveModel(response, parentObj, parentKey, value, reference) {
        ...
        if ("object" === typeof value && null !== value) {
            if (void 0 !== reference && void 0 !== response._temporaryReferences && response._temporaryReferences.set(value, reference), Array.isArray(value)) for(var i = 0; i < value.length; i++)value[i] = reviveModel(response, value, "" + i, value[i], void 0 !== reference ? reference + ":" + i : void 0);
    ...
    }, currentView = null, writtenBytes = 0, textEncoder = new TextEncoder(), CLIENT_REFERENCE_TAG$1 = Symbol.for("react.client.reference"), SERVER_REFERENCE_TAG = Symbol.for("react.server.reference"), FunctionBind = Function.prototype.bind, ArraySlice = Array.prototype.slice, previousDispatcher = ReactDOMSharedInternals.d;
    ...
    }, callIteratorInDEV = callIterator.react_stack_bottom_frame.bind(callIterator), isArrayImpl = Array.isArray, getPrototypeOf = Object.getPrototypeOf, jsxPropsParents = new WeakMap(), jsxChildrenParents = new WeakMap(), CLIENT_REFERENCE_TAG = Symbol.for("react.client.reference"), doNotLimit = new WeakSet();
    ...
    var ObjectPrototype = Object.prototype, stringify = JSON.stringify, PENDING$1 = 0, COMPLETED = 1, ABORTED = 3, ERRORED$1 = 4, RENDERING = 5, OPENING = 10, ABORTING = 12, CLOSING = 13, CLOSED = 14, PRERENDER = 21, currentRequest = null, debugID = null, modelRoot = !1, emptyRoot = {}, hasOwnProperty = Object.prototype.hasOwnProperty;
    ...
    var initializingChunk = null, initializingChunkBlockedModel = null, serverManifest = {};
    exports.createClientReference = function(id, exportName, bundles, importMap) {
        return {
    ...
    exports.decodeReply = function(body, options) {
        ...
        body = createResponse(serverManifest, "", options ? options.temporaryReferences : void 0, body);
    ...
    exports.decodeReplyFromAsyncIterable = function(iterable, options) {
        ...
        var iterator = iterable[ASYNC_ITERATOR](), response$jscomp$0 = createResponse(serverManifest, "", options ? options.temporaryReferences : void 0);
        iterator.next().then(progress, error);
    ...
    exports.loadServerAction = function(id) {
        ...
        return Promise.resolve(reference).then(function() {
            return preloadModule$1(reference);
        }).then(function() {
            var fn = requireModule(reference);
            if ("function" !== typeof fn) throw Error("Server actions must be functions");
            return fn;
        });
    };
    ...
    exports.renderToReadableStream = function(model, options) {
        var request = createRequest(model, null, options ? options.onError : void 0, options ? options.identifierPrefix : void 0, options ? options.onPostpone : void 0, options ? options.temporaryReferences : void 0, options ? options.environmentName : void 0, options ? options.filterStackFrame : void 0);
    ...
    exports.unstable_prerender = function(model, options) {
        return new Promise(function(resolve, reject) {
            var request = createPrerenderRequest(model, null, function() {
...
},{"b03dec9cf48797dd":"ae4HJ","406b8cd6607dac14":"7Ph5U"}],"ae4HJ":[function(require,module,exports,__globalThis) {
'use strict';
module.exports = require("2d2e62853a7289d4");

},{"2d2e62853a7289d4":"4NM1M"}],"4NM1M":[function(require,module,exports,__globalThis) {
/**
 * @license React
...
(function() {
    ...
    var React = require("b469c12171058714"), Internals = {
        d: {
            f: noop,
            r: function() {
...
},{"b469c12171058714":"7Ph5U"}],"2tNXh":[function(require,module,exports,__globalThis) {
/* @jsxRuntime automatic */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderRSC", ()=>renderRSC);
parcelHelpers.export(exports, "renderHTML", ()=>renderHTML);
parcelHelpers.export(exports, "renderRequest", ()=>renderRequest);
parcelHelpers.export(exports, "callAction", ()=>callAction);
parcelHelpers.export(exports, "renderDevError", ()=>renderDevError);
var _jsxDevRuntime = require("react/jsx-dev-runtime");
// Server dependencies.
var _serverEdge = require("react-server-dom-parcel/server.edge");
var _server = require("rsc-html-stream/server");
// Client dependencies, used for SSR.
// These must run in the same environment as client components (e.g. same instance of React).
var _clientEdge = require("react-server-dom-parcel/client.edge");
var _serverEdge1 = require("react-dom/server.edge");
function renderRSC(root, options) {
    return (0, _serverEdge.renderToReadableStream)(root, options);
}
async function renderHTML(root, options) {
    let rscStream = (0, _serverEdge.renderToReadableStream)(root, options);
    ...
    function Content() {
        ...
        data ??= (0, _clientEdge.createFromReadableStream)(s1);
        return data;
    }
    let htmlStream = await (0, _serverEdge1.renderToReadableStream)(/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(Content, {}, void 0, false, {
        fileName: "node_modules/.pnpm/@parcel+rsc@2.15.4_react-dom@19.1.1_react@19.1.1__react@19.1.1/node_modules/@parcel/rsc/src/server.tsx",
        lineNumber: 51,
        columnNumber: 53
    }, this), {
        ...options,
        bootstrapScriptContent: options?.component?.bootstrapScript
    });
    return htmlStream.pipeThrough((0, _server.injectRSCPayload)(s2));
}
const temporaryReferencesSymbol = Symbol.for('temporaryReferences');
async function renderRequest(request, root, options) {
    ...
    if (request.headers.get('Accept')?.includes('text/html')) try {
        let html = await renderHTML(root, options);
        ...
        let res;
        try {
            res = options?.renderError ? await renderHTML(options.renderError(error), options) : await renderDevError(error, options);
        } catch  {
...
async function callAction(request, id) {
    request[temporaryReferencesSymbol] ??= (0, _serverEdge.createTemporaryReferenceSet)();
    if (id) {
        let action = await (0, _serverEdge.loadServerAction)(id);
        let body = request.headers.get('content-type')?.includes('multipart/form-data') ? await request.formData() : await request.text();
        let args = await (0, _serverEdge.decodeReply)(body, {
            temporaryReferences: request[temporaryReferencesSymbol]
        });
        ...
        let action = await (0, _serverEdge.decodeAction)(formData);
...
async function renderDevError(error, options) {
    {
        let content = /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("html", {
            children: [
                ...
                /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("body", {
                    children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("noscript", {
                        children: [
        ...
        let bootstrapScript = options?.component?.bootstrapScript;
...
},{"react/jsx-dev-runtime":"j7ngv","react-server-dom-parcel/server.edge":"gxgmV","rsc-html-stream/server":"dFVmh","react-server-dom-parcel/client.edge":"7RckG","react-dom/server.edge":"hcrvg","@parcel/transformer-js/src/esmodule-helpers.js":"9CkkJ"}],"dFVmh":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "injectRSCPayload", ()=>injectRSCPayload);
...
function injectRSCPayload(rscStream, options) {
    ...
    function flushBufferedChunks(controller) {
        ...
        if (remaining.length) {
            if (remaining.endsWith(trailer)) remaining = remaining.slice(0, -trailer.length);
...
async function writeRSCStream(rscStream, controller, nonce) {
    ...
    for await (let chunk of rscStream)// Try decoding the chunk to send as a string.
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"9CkkJ"}],"9CkkJ":[function(require,module,exports,__globalThis) {
...
},{}],"13QQd":[function(require,module,exports,__globalThis) {
var _jsxDevRuntime = require("react/jsx-dev-runtime");
var _rscHelpers = require("@parcel/runtime-rsc/rsc-helpers");
let originalModule = module.bundle.root("f1Ybl");
let resources = /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("link", {
    rel: "stylesheet",
    href: "/client/RSC.9429d252.css",
    precedence: "default"
}, void 0, false, {
    fileName: "client/server/runtime-b2946b5dc0b92a0e.jsx",
    lineNumber: 3,
    columnNumber: 17
}, undefined);
let res = (0, _rscHelpers.createResourcesProxy)(originalModule, false, resources);
module.exports = res;

},{"react/jsx-dev-runtime":"j7ngv","@parcel/runtime-rsc/rsc-helpers":"lyXsv","f1Ybl":"f1Ybl"}],"lyXsv":[function(require,module,exports,__globalThis) {
/* eslint-env browser */ /* eslint-disable react/react-in-jsx-scope */ /* @jsxRuntime automatic */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createResourcesProxy", ()=>createResourcesProxy);
parcelHelpers.export(exports, "waitForCSS", ()=>waitForCSS);
var _jsxDevRuntime = require("react/jsx-dev-runtime");
function createResourcesProxy(module, esModule, resources, bootstrapScript) {
    if (typeof module === 'function') return createResourcesValueProxy(module, resources, bootstrapScript);
    return new Proxy(module, {
        get (target, prop, receiver) {
            if (prop === '__esModule' && esModule) return true;
...
function createResourcesValueProxy(value, resources, bootstrapScript) {
    if (typeof value === 'function') {
        ...
        let prototypeProxy;
        if (typeof value.prototype === 'object') prototypeProxy = new Proxy(value.prototype, {
            get (target, prop, receiver) {
                if (prop === 'isReactComponent') isReactComponent = true;
                return Reflect.get(target, prop, receiver);
            }
        });
        let proxy = new Proxy(value, {
            get (target, prop, receiver) {
                if (prototypeProxy && prop === 'prototype' && Object.getOwnPropertyDescriptor(target, 'prototype').configurable) return prototypeProxy;
                if (prop === '$$typeof') isReactComponent = true;
                if (bootstrapScript && prop === 'bootstrapScript') return bootstrapScript;
                return Reflect.get(target, prop, receiver);
            },
            apply (target, thisArg, args) {
                let result = Reflect.apply(target, thisArg, args);
                if (isReactComponent) return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _jsxDevRuntime.Fragment), {
                    children: [
                        resources,
                        result
                    ]
...
},{"react/jsx-dev-runtime":"j7ngv","@parcel/transformer-js/src/esmodule-helpers.js":"9CkkJ"}]},["1CVDg","aRXdd","aROs2"], "aROs2", "parcelRequire94c2", {}, "./", "/")
